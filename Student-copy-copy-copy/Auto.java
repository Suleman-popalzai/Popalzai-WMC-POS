...
public class Auto
{
 ...
 if (person == null) {
     throw new IllegalArgumentException("Parameter person darf null sein");
    }
    
 if (person.equals(fahrer)|| person.equals(beifahrer) || person.equals(rueckbank)){
    throw new IllegalArgumentException("Diese Person sitzt schon im Auto");
 } 
 ...
 throw new IllegalArgumentException("Das Auto ist voll");
}
